/*
 * Vendored verbatim from freeink-sdk (libs/assets/Icons/include/Icon.h),
 * MIT License, Copyright (c) 2026 FreeInk — see
 * references/crosspoint-reader/freeink-sdk/LICENSE. Not MySafeFob's own
 * code (no MySafeFob copyright header): a tiny, hardware-agnostic struct
 * with no reason to diverge from upstream (docs/esp-project-boilerplate/
 * importing-features.md, "copy verbatim" bucket).
 */
#pragma once
