 ...
 *        cmd_charge), formulas see docs/hardware-specs.md. Identical copy of
 *        boards/x4pro/factory/main/battery.{c,h} (same hardware, no board
 *        divergence expected — ADR-010 pt.3's rule extended to this driver).
 */
#pragma once
